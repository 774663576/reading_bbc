...
class ArticleInfo:
    ...
    update_time: str
    views: int
    category: str = "q-and-a"  # 添加默认值

class BBCLearningEnglishScraper:
    def __init__(self, category: str = 'q-and-a', start_pos: int = 0, count: int = 50):
        """初始化爬虫配置"""
...
def main():
    ...
    # 列表页URL
    list_url = 'https://www.bbc.co.uk/learningenglish/chinese/features/q-and-a'
